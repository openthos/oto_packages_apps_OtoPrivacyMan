...
import org.openthos.privacyman.hacks.BootCompletedHack;
import org.openthos.privacyman.hacks.FixOpsPruneHack;
import org.openthos.privacyman.hacks.FixWakeLock;
import org.openthos.privacyman.hacks.GeneralHacks;
import org.openthos.privacyman.hacks.MiuiHacks;
...
public abstract class Hack implements IXposedHookLoadPackage, IXposedHookZygoteInit,
    ...
    public final PreferenceInfo getPrefernceInfo(Context context) {
        return new PreferenceInfo(getKey(), onGetPreferenceTitle(context),
                onGetPreferenceSummary(context));
    }
    ...
    protected final String getPreferenceString(Context context, String suffix,
                                               Object... formatArgs) {
