			...
			OnPreferenceChangeListener, OnSharedPreferenceChangeListener
	{
		...
		public boolean onPreferenceChange(Preference preference, Object newValue)
		{
			...
			else if("compatibility_mode".equals(preference.getKey()))
			{
				...
				pm.setComponentEnabledSetting(new ComponentName(getActivity(), "org.openthos.privacyman.LauncherActivity$HtcActivity"),
						useCompatibilityMode ? PackageManager.COMPONENT_ENABLED_STATE_ENABLED : PackageManager.COMPONENT_ENABLED_STATE_DISABLED,
						PackageManager.DONT_KILL_APP);

				pm.setComponentEnabledSetting(new ComponentName(getActivity(), "org.openthos.privacyman.LauncherActivity$HtcFragment"),
			...
			else if("show_launcher_icon".equals(preference.getKey()))
			{
				...
				final PackageManager pm = getActivity().getPackageManager();
				pm.setComponentEnabledSetting(new ComponentName(getActivity(), "org.openthos.privacyman.LauncherActivity-Icon"),
